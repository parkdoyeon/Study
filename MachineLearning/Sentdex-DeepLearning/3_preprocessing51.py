...
convert_to_vec(getdata.get('test_set.csv'),getdata.get('processed-test-set.csv'),getdata.get('lexicon-2500-2638.pickle'))
...
def shuffle_data(fin):
	...
	print(df.head())
	df.to_csv(getdata.get('train_set_shuffled.csv'), index=False)
	
shuffle_data(getdata.get('train_set.csv'))
...
create_test_data_pickle(getdata.get('processed-test-set.csv'))